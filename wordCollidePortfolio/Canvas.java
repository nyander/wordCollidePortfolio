...
public class Canvas
{
    ...
    /**
     * Draw a given text shape onto the canvas.
     * @param  referenceObject  an object to define identity for this text shape
    ...
    private class ShapeDescription
    {
        ...
        public void draw(Graphics2D graphic)
        {
            ...
            if (shape != null) {
                ...
                Integer yTop = txt.getYPosition() - txt.getTextHeight();
                graphic.draw(new java.awt.Rectangle(txt.getXPosition(), yTop, 
                txt.getTextWidth(), txt.getTextHeight()));
            }
        }
    }
